...
const closeModal2 = ()=> setIsOpen2(false)
  ...
  return (
    <div  className='w-full h-screen p-4'>
        ...
        <Slide triggerOnce><div className='border-2 border-[#AFFFCE] w-full mb-8'></div></Slide>
        ...
        <div className='flex flex-row shrink items-center gap-12 px-4  w-full h-[210px] snap-mandatory snap-x scroll-smooth overflow-y-hidden bg-[#2D2525] bg-opacity-25 rounded-lg mx-auto mb-8'>
        ...
        gap-12 px-4 w-full h-[210px] snap-mandatory snap-x scroll-smooth 
