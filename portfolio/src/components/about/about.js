...
const About = () => {
  return (
    <div  className=' w-full p-4 sm:px-8'>
        ...
        <span className='text-[#2D2525] text-sm font-medium sm:font-semibold sm:text-2xl md:text-3xl dark:text-white'> 
        ...
        <div className='w-full flex-row mb-8' >
        <div className='w-[280px] h-[190px] sm:w-[500px] sm:h-[350px] md:w-[700px] md:h-[520px] py-4 px-2 mx-auto '>
