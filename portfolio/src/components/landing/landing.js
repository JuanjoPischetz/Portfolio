  ...
  return (
    <div  className='w-full h-screen flex flex-col-reverse justify-around content-center p-2 '>
        <div className='w-full h-[300px] text-center md:mb-[80px]'>
            ...
            <p className='text-xl sm:text-3xl md:text-4xl text-[#2D2525] font-medium dark:text-[#C5C5C5]'>
                Hi! my name is,
             </p>
            <p className='text-4xl sm:text-5xl md:text-7xl font-bold text-[#2D2525] dark:text-white'>
                Juan José Pischetz
            </p>
            <p className='text-lg sm:text-3xl md:text-4xl mb-4 text-[#2D2525] font-medium dark:text-[#C5C5C5]'>
                Im a <span className='text-2xl sm:text-4xl md:text-5xl font-bold text-[#7A1E33] dark:text-[#FFBB00]'>Full Stack Developer</span>
            </p>
            </Fade>
            </div>
            ...
            <Fade cascade damping={0.2} delay={4000} triggerOnce>
                ...
                <img className='w-[65px] h-[65px] sm:w-[100px] sm:h-[100px] dark:bg-white' src="https://profilinator.rishav.dev/skills-assets/postgresql-original-wordmark.svg" alt="PostgreSQL"  />
                <img className='w-[65px] h-[65px] sm:w-[100px] sm:h-[100px] dark:invert' src="https://profilinator.rishav.dev/skills-assets/express-original-wordmark.svg" alt="Express.js"  />
